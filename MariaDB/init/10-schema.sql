...
--
-- Dumping events for database 'wl'
--

--
-- Dumping routines for database 'wl'
--
...
/*!50003 DROP FUNCTION IF EXISTS `getpwd` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` FUNCTION `getpwd`(namec VARCHAR(64)) RETURNS varchar(4000) CHARSET latin1
    READS SQL DATA
BEGIN
    DECLARE passwdtemp VARCHAR(64);
       SELECT passwd INTO passwdtemp FROM users WHERE name = namec;
       IF( passwdtemp IS NOT NULL) THEN
           SELECT fn_varbintohexsubstring(1,passwdtemp,1,0) INTO passwdtemp;
           RETURN passwdtemp;
       END IF;
       RETURN null;
END ;;
...
-- Dump completed on 2025-09-27  8:27:30
